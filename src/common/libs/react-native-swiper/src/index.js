...
const styles = {
  ...
  pagination_x: {
    position: 'absolute',
    bottom: StyleMethods.getFontSize(25),
    left: 0,
    right: 0,
    flexDirection: 'row',
    flex: 1,
  ...
  pagination_y: {
    position: 'absolute',
    right: StyleMethods.getFontSize(15),
    top: 0,
    bottom: 0,
  ...
  title: {
    ...
    justifyContent: 'center',
    position: 'absolute',
    paddingLeft: StyleMethods.getFontSize(10),
    bottom: StyleMethods.getFontSize(-30),
    left: 0,
    flexWrap: 'nowrap',
    width: StyleMethods.getFontSize(250),
    backgroundColor: 'transparent'
  },
  ...
  buttonWrapper: {
    ...
    left: 0,
    flex: 1,
    paddingHorizontal: StyleMethods.getFontSize(0),
    paddingVertical: StyleMethods.getFontSize(0),
    justifyContent: 'space-between',
    alignItems: 'center'
  },

  buttonText: {
    fontSize: StyleMethods.getFontSize(50),
    //color: '#007aff',
...
export default class extends Component {
  ...
  renderPagination = () => {
    ...
    const ActiveDot = this.props.activeDot || <View style={[{
      backgroundColor: this.props.activeDotColor || COLORS.WHITE,//'#007aff',
      width: StyleMethods.getFontSize(12),
      height: StyleMethods.getFontSize(12),
      borderRadius: StyleMethods.getFontSize(6),
      marginLeft: StyleMethods.getFontSize(3),
      marginRight: StyleMethods.getFontSize(3),
      marginTop: StyleMethods.getFontSize(3),
      marginBottom: StyleMethods.getFontSize(3)
