        ...
        {/*}
          <View style={{flex:.12}} >
            <Icon ref="ICON"
              ...
              color={iconcolor} style={{alignSelf:'center',backgroundColor:'transparent'}}/>
          </View>
        */}
          <TextInput
            ...
            secureTextEntry={secureTextEntry} multiline={multiline} keyboardType={keyboardType} autoCorrect={autoCorrect} autoCapitalize={autoCapitalize}
            onFocus={() => {
...
const styles = StyleSheet.create({
  ...
  textInput: {
    //marginLeft:StyleMethods.getCorrectFontSizeForScreen(50),
