...
class WalkThrough extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      visibleArea:{width:StyleMethods.getFontSize(95),height:StyleMethods.getFontSize(100), position:'absolute', left:StyleMethods.getFontSize(-25), top:StyleMethods.getFontSize(20)}
    };
  }
  ...
  handleStepChange = (step) => {
    if(step.name ==="Menu"){
      this.setState({menuVisible:false, visibleArea:{width:StyleMethods.getFontSize(95),height:StyleMethods.getFontSize(100), position:'absolute', left:StyleMethods.getFontSize(-35), top:StyleMethods.getFontSize(30)}});//20, 108, 198, 288, 378, 468
    }else if(step.name ==="The Story Feed" || step.name ==="L-Għalf tal-Istorja"){
      this.setState({menuVisible:true, visibleArea:{width:StyleMethods.getFontSize(95),height:StyleMethods.getFontSize(100), position:'absolute', left:StyleMethods.getFontSize(-25), top:StyleMethods.getFontSize(20)}});
    }else if(step.name === "Featured Videos" || step.name === "Videos Dehru"){
      this.setState({menuVisible:true, visibleArea:{width:StyleMethods.getFontSize(95),height:StyleMethods.getFontSize(100), position:'absolute', left:StyleMethods.getFontSize(-25), top:StyleMethods.getFontSize(108)}});
    }else if(step.name === "My Story"){
      this.setState({menuVisible:true, visibleArea:{width:StyleMethods.getFontSize(95),height:StyleMethods.getFontSize(100), position:'absolute', left:StyleMethods.getFontSize(-25), top:StyleMethods.getFontSize(198)}});
    }else if(step.name === "Live"){
      this.setState({menuVisible:true, visibleArea:{width:StyleMethods.getFontSize(95),height:StyleMethods.getFontSize(100), position:'absolute', left:StyleMethods.getFontSize(-25), top:StyleMethods.getFontSize(288)}});
    }else if(step.name === "TVMi"){
      this.setState({menuVisible:true, visibleArea:{width:StyleMethods.getFontSize(95),height:StyleMethods.getFontSize(100), position:'absolute', left:StyleMethods.getFontSize(-25), top:StyleMethods.getFontSize(378)}});
    }else if(step.name === "Search"){
      this.setState({menuVisible:true, visibleArea:{width:StyleMethods.getFontSize(95),height:StyleMethods.getFontSize(100), position:'absolute', left:StyleMethods.getFontSize(-25), top:StyleMethods.getFontSize(468)}});
    }else if(step.name === "Preferences" || step.name === "Preferenzi"){
      this.setState({menuVisible:true, visibleArea:{width:StyleMethods.getFontSize(95),height:StyleMethods.getFontSize(100), position:'absolute', right:StyleMethods.getFontSize(-40), top:StyleMethods.getFontSize(30)}});
    }
  }

  renderWalktrhoughModal = ( item ) => {
    return (
      <CopilotStep ref={(ref) => this.copilotRef = copilotRef = ref} text={item.desc} order={item.order} name={item.title}>
